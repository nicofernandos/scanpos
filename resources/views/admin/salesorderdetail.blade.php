  ...
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div>
          <a href="{{ url('saleorder') }}" class="btn btn-secondary btn-sm">
            <i class="bx bx-arrow-back me-1"></i>Kembali
          </a>
          <a href="{{ url('saleorder/cetak/'.$saleorder->id) }}" class="btn btn-primary btn-sm" target="_blank">
          ...
          <div class="col-md-6 mb-3">
            <div class="bg-light p-3 rounded">
              <h6 class="fw-bold text-primary mb-3">
                <i class="bx bx-file-blank me-2"></i>Informasi Sale Order
              </h6>
              <div class="row mb-2">
                <div class="col-sm-4">
                  <span class="fw-medium">No. Sale Order:</span>
                </div>
                <div class="col-sm-8">
                  <span class="badge bg-primary">{{ $saleorder->noso }}</span>
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8">
                  <span>{{ date('d/m/Y', strtotime($saleorder->tglfp)) }}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              @php $no = 1; @endphp
              @forelse($saleorder->salesorderdetails as $detail)
              <tr>
            ...
            <tfoot>
              <tr>
                ...
                <th class="text-end">
                  <span class="fw-bold text-success">
                    Rp {{ number_format($saleorder->tot, 0, ',', '.') }}
